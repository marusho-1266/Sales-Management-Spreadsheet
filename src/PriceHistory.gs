...
function addSamplePriceHistoryData(sheet) {
  const sampleData = [
    ['PROD001', 'iPhone 15 Pro 128GB', '2025-09-25 10:00:00', 120000, 150000, '変動なし', 0, 0, 0, '初回登録'],
    ['PROD001', 'iPhone 15 Pro 128GB', '2025-09-26 10:00:00', 118000, 150000, '仕入れ価格下落', -2000, 0, -1.67, 'セール価格'],
    ['PROD001', 'iPhone 15 Pro 128GB', '2025-09-27 10:00:00', 118000, 148000, '販売価格下落', 0, -2000, -1.33, '競合価格調整'],
    ['PROD002', 'MacBook Air M2 13インチ', '2025-09-25 10:00:00', 140000, 180000, '変動なし', 0, 0, 0, '初回登録'],
    ['PROD002', 'MacBook Air M2 13インチ', '2025-09-26 10:00:00', 140000, 180000, '変動なし', 0, 0, 0, '価格維持'],
    ['PROD002', 'MacBook Air M2 13インチ', '2025-09-27 10:00:00', 142000, 180000, '仕入れ価格上昇', 2000, 0, 1.43, '為替変動'],
    ['PROD003', 'AirPods Pro 第2世代', '2025-09-25 10:00:00', 25000, 35000, '変動なし', 0, 0, 0, '初回登録'],
    ['PROD003', 'AirPods Pro 第2世代', '2025-09-26 10:00:00', 25000, 35000, '変動なし', 0, 0, 0, '価格維持'],
    ['PROD003', 'AirPods Pro 第2世代', '2025-09-27 10:00:00', 25000, 35000, '変動なし', 0, 0, 0, '価格維持']
  ];
